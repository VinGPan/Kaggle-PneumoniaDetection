...
def FCN32_aug( n_classes ,  input_height=416, input_width=608 , vgg_level=3):
    ...
    tmp_shape = Model(img_input, o).output_shape
    dense_sz = tmp_shape[1] * tmp_shape[2] * tmp_shape[3]
    o = (Flatten())(o)
    o = Concatenate()([o, aug_input])
    o = (Dense(dense_sz, activation='relu', kernel_initializer='he_normal'))(o)
    o = (Reshape((tmp_shape[1], tmp_shape[2], tmp_shape[3])))(o)
